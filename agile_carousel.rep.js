...
(function ($) {
    ...
    $.fn.agile_carousel = function (options) {
        ...
        return this.each(function () {
            ...
            var combined_slide_height = 0,
            	number_of_slides = 0;
            	ac_html = "";
            	ac_control_set_container = "";
            	ac_content = "";
            	ac_numbered_buttons = "";
            ...
            ac_html += "<div class='agile_carousel' style='overflow: hidden; position: relative; height: " + carousel_outer_height + "px; width: " + carousel_outer_width + "px;'>";
            ...
            for (var key in carousel_data) {
                ...
                if (carousel_data.hasOwnProperty(key)) {
                    ...
                    if (i === 1) {
                        ac_html += "<div class='slides' style='height: " + slide_height * number_of_slides + "px; width: " + slide_width + "px;'>";
                    } // if
                    if (content) {
                        // render
                        ac_html += "<div class='slide_" + i + " slide' style='border: none; margin: 0; padding: 0; width: " + slide_width + "px; height: " + slide_height + "px;'>" + content + "</div>";
            ...
            var create_control_set = function (set, set_number) {
                ...
                if (set !== "") {
                    ...
                    ac_control_set_container += control_set_html;

                } // if
            }; // function

            ac_control_set_container += "<div class=\"control_set_container\">";
            ...
            ac_control_set_container += "</div>";
            ac_html += ac_control_set_container;
            ...
            if (number_slides_visible == 1) {
                ...
                ac_slides_container.css("height", slide_height + "px");
            ...
            if (number_slides_visible > 1) {
                ...
                agile_carousel.css("height", number_slides_visible * slide_height + "px");
                    ...
                    if (next_slide_index != current_slide_index) {
                        ...
                        if (transition_type == "slide" && number_slides_visible > 1) {
                            ...
                            ac_slides_container.stop().animate({
                                "top": ((next_slide_number * slide_height) - slide_height) * -1 + "px"
                            }, {
                        ...
                        if (transition_type == "slide" && number_slides_visible == 1) {
                            ...
                            if (button_action == "next" || (next_slide_number > current_slide_number) && button_action == "direct") {
                                ...
                                animate_current_slide_to = slide_height * -1;
                            ...
                            if (button_action == "previous" || (next_slide_number < current_slide_number && button_action == "direct")) {
                                ...
                                animate_current_slide_to = slide_height;
                            }
                            ...
                            current_slide.stop().animate({
                                "top": animate_current_slide_to + "px"
                            }, {
                                duration: transition_time,
